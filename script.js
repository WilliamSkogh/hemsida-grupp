...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedTheme) {
      ...
      document.body.classList.add('ljustema');
      localStorage.setItem('theme', 'ljustema');
    }
  });
  
  document.getElementById('toggleTheme').addEventListener('click', () => {
    if (document.body.classList.contains('ljustema')) {
      document.body.classList.remove('ljustema');
      document.body.classList.add('morktema');
      localStorage.setItem('theme', 'morktema');
    } else {
      document.body.classList.remove('morktema');
      document.body.classList.add('ljustema');
      localStorage.setItem('theme', 'ljustema');
    }
  });
